                          ...
                          int stream_size)
{
     ...
     * written and what is readBytes in the overlain buffers, so the symbols cannot
 ...
 * and total number of bytes readBytes.  All deflate() input goes through
 ...
 *    At least one byte has been readBytes, or avail_in == 0; reads are
